...
<div class="container">
  ...
  @endif
  <a class="navbar-brand js-scroll-trigger" href="#page-top">Valentine's Cake House</a>
  ...
  <div class="collapse navbar-collapse" id="navbarResponsive">
    <ul class="navbar-nav text-uppercase ml-auto">
      <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#services">How To Order</a>
      </li>
      <li class="nav-item">
      ...
      @else
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/order">Order Now</a>
          </li>
      @endguest
    </ul>
  </div>
